...
import com.redlongcitywork.gasshop.template.utils.GasPortionRowMapper;
...
public class GasPortionDaoJdbcTemplateImpl implements GasPortionDao {
    ...
    private static final Logger LOG = Logger.getLogger(com.redlongcitywork.gasshop.jdbc.daoimpl.GasPortionDaoJdbcImpl.class.getName());
